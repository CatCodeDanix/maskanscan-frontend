      ...
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          `
            ...
            overflow-x-hidden overflow-y-auto rounded-lg p-1 shadow-md ring-1
            duration-100
    ...
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        `
          ...
          relative flex cursor-default items-center gap-1.5 rounded-md px-1.5
          py-1 text-sm outline-hidden select-none
    ...
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        `
          ...
          z-50 min-w-[96px]
          origin-(--radix-dropdown-menu-content-transform-origin)
          overflow-hidden rounded-lg p-1 shadow-lg ring-1 duration-100
        `,
        className
      )}
      {...props}
